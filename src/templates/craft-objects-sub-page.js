...
const BlogPostTemplate = (props) => {
  ...
  const nextLinkStatus = pageContext?.next ? pageContext?.next?.frontmatter?.templateKey === 'craft-objects-sub-page' ? true : false : false
  const previousLinkStatus = pageContext?.previous ? pageContext?.previous?.frontmatter?.templateKey === 'craft-objects-sub-page' ? true : false : false
