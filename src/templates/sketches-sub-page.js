...
const BlogPostTemplate = (props) => {
  ...
  const nextLinkStatus = pageContext?.next ? pageContext?.next?.frontmatter?.templateKey === 'sketches-sub-page' ? true : false : false
  const previousLinkStatus = pageContext?.previous ? pageContext?.previous?.frontmatter?.templateKey === 'sketches-sub-page' ? true : false : false
